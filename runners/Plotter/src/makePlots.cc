...
int main(int argc, char **argv) {
    ...
    std::vector<histInfo> histInfos = {
        // V vars:
        //histInfo("HistName", "PlotBranchName", "xLabel", "WeightBranchName", bins, lowerBound, upperBound),
    ...
    // List of all region names, should correspond to the bins of the axes other than the systematic and main variable
    std::vector<std::vector<std::string>> allRegionNames = {{"Channel"},
                                                            {"Control Region"},
    ...
    // Book all the histograms, provide a suffix of "All" to these. This can be called multiple times
