...
void CounterService::finalize(ROOT::RDF::RNode& df) {
  ...
  std::cout << "CounterService: meta output sink is valid" << std::endl;
  ...
  std::cout << "Triggering count" << std::endl;
  auto countResult = targetDf.Count();
  std::cout << "Count triggered, waiting for result..." << std::endl;
  ...
  */
  ...
  //std::cout << "Formatting elapsed time for logging" << std::endl;
  ...
  */
  //if (hasWeightSignSum) {
  //std::cout << "Getting weight sign sum result value" << std::endl;
  auto signWeightValue = weightSignSumResult.GetValue();
  //std::cout << "Weight sign sum result value: " << signWeightValue << std::endl;
  //std::cout << "ctx_m->logger is " << &(ctx_m->logger) << std::endl;
  ...
  */
  //std::cout << "CounterService: Finished logging counts and speeds" << std::endl;
  //std::cout << "Meta output sink pointer: " << &(ctx_m->metaSink) << std::endl;
  //std::cout << "configProvider pointer: " << &(ctx_m->config) << std::endl;
  std::string fileName = ctx_m->metaSink.resolveOutputFile(ctx_m->config, OutputChannel::Meta);
  //std::cout << "CounterService: Resolved meta output file name: " << fileName << std::endl;
  if (!fileName.empty()) {
